        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <img id="current_image" src="{{ asset('admin_asset/img/photos/' . ($product_info->product_img ?? 'blocks.png')) }}" alt="Current Product Image" class="img-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('product.update' , $product_info->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        @csrf
                        @method('PUT')
                        <label for="product_name" class="fw-bold mb-2">Nhập tên sản phẩm thay đổi</label>
                        <input type="text" name="product_name" id="product_name" class="form-control"
                            value="{{$product_info->product_name}}">

                        <label for="product_price" class="fw-bold mb-2">Nhập giá cả sản phẩm thay đổi</label>
                        <input type="number" name="product_price" id="product_price" class="form-control"
                        value="{{$product_info->product_price}}" step="0.01" min="0">


                        <label for="product_cat_name" class="fw-bold mb-2">Chọn Chuyên mục lớn thay đổi</label>
                        ...
                        <label for="product_subcat_name" class="fw-bold mb-2">Chọn Chuyên mục nhỏ thay đổi</label>
                        <div class="form-outline position-relative">
                        ...
                        <label for="product_attribute_name" class="fw-bold mb-2">Chọn dữ liệu ban đầu thay đổi</label>
                        <div class="form-outline position-relative">
                        ...
                        <label for="product_status" class="fw-bold mb-2">Chọn trạng thái sản phẩm thay đổi</label>
                        <div class="form-outline position-relative">
                        ...
                        <label for="product_quantity" class="fw-bold mb-2">Nhập số lượng sản phẩm thay đổi</label>
                        ...
                        <div class="card mt-2">
                            <label for="product_img" class="fw-bold mb-2">Chọn lại hình ảnh thay đổi</label>
                            <input type="file" name="product_img" id="product_img" class="form-control form-control-lg"
                                onchange="previewImage(event)">
                        </div>
                        <button type="submit" class="btn btn-primary w-100 mt-2">Sửa sản phẩm</button>
                    </form>
