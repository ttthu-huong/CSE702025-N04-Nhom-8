        ...
        <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-xl p-8">
            ...
            <form action="{{route('customer.product.insertorder')}}" method="post">
                ...
                <table class="w-full text-left table-auto">
                    ...
                    <tr class="border-b">
                        <th class="py-3 px-4 text-lg font-medium text-gray-700">Giá Sản Phẩm:</th>
                        <td class="py-3 px-4 text-lg text-gray-600">{{ $productPrice }} VND</td>
                    </tr>
                    <tr class="border-b">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-3 px-4 text-lg font-semibold text-red-600">{{ $totalPrice }}.000 VND
                        </td>
                    </tr>
                    <tr class="border-b">
                        ...
                        <td class="py-3 px-4 text-lg text-gray-600">
                            ...
                            nhận hàng<br>
                            <input type="radio" name="payment_method" value="Thanh toán trước khi nhận hàng"> Thanh toán
                            trước khi nhận hàng
                        </td>
                    </tr>
                    <tr class="border-b">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-3 px-4 text-lg text-gray-600">
                            <input type="text" class="rounded-xl w-full" placeholder="Nhập địa chỉ" name="order_address">
                        </td>
                    </tr>
                    <tr class="border-b">
                        <th colspan="2">
