...
@section('seller_page_title')
    Manage Ship order - Seller Panel
@endsection
@section('seller_layout')
    ...
    <div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
        <div class="col-7">
            <div class="card">
                <form action="{{ route('vendor.order.createship') }}" method="post">
                    @csrf
                    ...
                    <div class="card-body">
                        <table class="table table-responsive">
                            ...
                            <tr>
                                <th>Số điện thoại :</th>
                                <td>
                                    <input type="hidden" name="ship_phonenumber"
                        ...
                        <button type="submit" class="btn btn-success rounded-pill form-control fs-3 mt-4">Xác nhận gửi ship
                            đơn hàng</button>
                    </div>
                </form>
            </div>
