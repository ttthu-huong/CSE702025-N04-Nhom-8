        ...
        <div class="row">
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th colspan="3"></th>
                                    <th>
                                        <form action="{{ route('vendor.review.truncate_order') }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger form-control">Clear</button>
                                        </form>
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('vendor.review.delete_item_order', $order->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
            ...
            <div class="col-lg-6 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('vendor.review.insert_order') }}" method="post">
                            @csrf
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span>{{ $quantity }}</span>
                                            <input type="hidden" name="ac_order_totalquantitypro"
                                                value="{{ $quantity }}">
                                        </td>
                                    </tr>
                                    <tr>
